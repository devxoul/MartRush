	...
	if( self = [super init] )
	{
        ...
        info = [CCMenuItemImage itemFromNormalImage:@"cartbutton.png" selectedImage:@"cartbutton_pressed.png" block:^(id sender) {
            if (gameScene.gameState == GAME_STATE_START) {
                ...
                missionLabel = [CCLabelTTF labelWithString:msg dimensions:CGSizeMake(400,140) alignment:UITextAlignmentCenter lineBreakMode:UILineBreakModeWordWrap  fontName:@"BurstMyBubble.ttf" fontSize:55];
